...
void LinkedList::reversal(){
    ...
    //Important - the head of the list starts from the previous node after reversal; at the end of the traversal of while loop,
    //the curr and next pointers are pointing at null while the previous pointer is point at the last node of the linked list.
    head = prev; 
}
